...
@Component({
    ...
    <div>
        ...
        <div class="top-nav">
          ...
          <!--  <div>
            <button mat-flat-button (click)="handleClick('assign-program','')" style="border: solid black 1px;">Assign program</button>
           </div> -->
           <div>
            <button mat-flat-button (click)="handleClick('create','')" style="background-color: #3CCD5C; color: white">Create</button>
           </div>
        </div>
        ...
        <ng-container matColumnDef="action">
          ...
          <td mat-cell *matCellDef="let element">  
              <button mat-flat-button (click)="handleClick('detail', element.id)" style="margin: 5px;">Detail</button>
...
<!--               <dialog-animations-example></dialog-animations-example>
 -->
              <button mat-flat-button color="warn" (click)="handleClick('delete', element.id)" style="margin: 5px;">Delete</button>
          </td>
        </ng-container>
 ...
 th {
     background-color: rgb(209, 207, 204) !important;
